...
public class BotonContraFlorEventHandler implements EventHandler<ActionEvent>{
	...
	//constructor
	public BotonContraFlorEventHandler(PartidaDeTruco partida, VentanasDelJuego visual){
	...
	public void handle(ActionEvent actionEvent){
		try{
			visual.modificarEtiquetaInformacion(this.partida.obtenerNombreDelJugadorConTurno() + " CANTO: "+ "  CONTRA FLOR");
